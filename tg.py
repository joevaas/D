...
# Generate a short hash to preserve uniqueness
short_hash = hashlib.md5(output_filename.encode()).hexdigest()[:8]

# Trim and append hash
safe_title = title[:100].strip().replace(' ', '_')
output_filename = f"{output_directory}/{safe_title}_{short_hash}.{output_format}"
